...
from src.prototype.models.popularity.recentpop import RecentPopRecommender
...
DATASET_CONFIGS = {
    "movielens": {
        ...
        "output_file": "results_prototype/movielens_recentpop_recommendations.csv",
    },
    "amazon": {
        "label": "Amazon",
        "train_file": "data/processed/amazon_train.csv",
        "test_file": "data/processed/amazon_test.csv",
        "output_file": "results_prototype/amazon_recentpop_recommendations.csv",
    },
}
