...
def main() -> None:
    ...
    parser.add_argument("--workers", type=int, default=1, help="Independent CPU batch workers for neighbourhood models only; serial is the reproducibility-safe default")
